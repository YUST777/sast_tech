...
export default function LoginCardSection() {
  ...
  return (
    <section className="fixed inset-0 bg-zinc-950 text-zinc-50">
      ...
      {/* Split Layout */}
      <div className="h-full w-full grid lg:grid-cols-2 relative z-10 pt-16 lg:pt-0">
        {/* Left Side: Text / Brand Info */}
        <div className="hidden lg:flex flex-col justify-center px-12 lg:px-24 xl:px-32">
          <div className="max-w-md space-y-6 card-animate" style={{ animationDelay: "0.2s" }}>
            <div className="inline-flex items-center rounded-full border border-zinc-800 bg-zinc-900/50 px-3 py-1 text-sm text-zinc-300 backdrop-blur-md">
            ...
            <p className="text-lg text-zinc-400">
              Join thousands of developers building scalable, reliable, and secure applications. Everything you need, out of the box.
            </p>
            <div className="grid grid-cols-2 gap-4 pt-4 text-sm text-zinc-400">
              <div className="flex border-l-2 border-zinc-800 pl-4 flex-col">
                <span className="text-zinc-100 font-semibold text-lg">10ms</span>
                Global latency
              </div>
              <div className="flex border-l-2 border-zinc-800 pl-4 flex-col">
                <span className="text-zinc-100 font-semibold text-lg">99.99%</span>
                Uptime SLA
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-center px-4 sm:px-6 lg:justify-start lg:px-12 xl:px-24">
          <Card className="card-animate w-full max-w-sm border-zinc-800 bg-zinc-900/70 backdrop-blur supports-[backdrop-filter]:bg-zinc-900/60 shadow-xl">
            ...
            <CardFooter className="flex items-center justify-center text-sm text-zinc-400">
              ...
              <a className="ml-1 text-zinc-200 hover:text-white transition-colors hover:underline" href="#">
                Create one
              </a>
            </CardFooter>
          </Card>
